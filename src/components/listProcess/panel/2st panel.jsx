...
const Panel_two = (props) => {
  return (
    <div className={style.panel}>
      <div className={style.name_panel}>
        <span className={style.name_credit}>
          Подготовка и прохождение платежей
        </span>
      ...
      <div className={style.items}>
        <div className={style.item_content_refresh}>
          ...
          <div className={style.number}>981</div>
        </div>
      ...
      <div className={style.items}>
        <div className={style.item_content_time}>
          <div className={style.clock}>
            ...
            <span className={style.time}>24 ч</span>
          ...
          <div className={style.close_clock}>
            ...
            <span className={style.time}>1ч (4,2%)</span>
      ...
      <div className={style.items}>
        <div className={style.item_content_time}>
          <div>
            ...
            <span className={style.time}>3 сотрудника</span>
            ...
            <div>
              ...
              <span className={style.time}>7 сценариев</span>
